...
tweaks = [
    ...
    },
    {
        ...
        "min_ios": "5.1",
        "changes": [
            [ "1.5.0~b12", "Added an error alert if uemoji.icu is not accessible due to jailbreak detection bypass tweak" ],
    ...
    },
    {
        ...
        "min_ios": "5.1",
        "changes": [
            [ "1.4.0~b4", "Fixed emoji picker for handholding emojis not rendering correctly" ],
